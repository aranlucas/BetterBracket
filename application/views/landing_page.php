...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" role="form" method="POST" action="<?php echo base_url();?>landing/">
      ...
      <form class="form-signin" role="form" method="POST" action="<?php echo base_url();?>landing/register">
