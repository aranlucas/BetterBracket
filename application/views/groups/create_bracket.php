...
<body>
   ...
   //                  		echo '<a href="#"><div id="'.( $round == 1 ? $identifier : $filler_id).'" class="team">';
		 ...
		 //                    echo '<p class="team_name">'.($round == 1 ? $bracket_data[$region][$games[$counts[$round]][$c]]['team_name'] : "").'</p>';
		 //                    echo '</div></a>';
			// 				echo '</div>';
			// 				$counts[$round]++;
			// 			}
	  ...
	  //                   		echo '<a href="#"><div id="'.( $round == 1 ? $identifier : $filler_id).'" class="team">';
			...
			//                     $identifier = $region.'-'.$round.'-'.$j.'-'.$bracket_data[$region][$games[$counts[$round]][$c]]['team_id'];
